...
public class PopInputMsg : BasePopWin
{
    ...
    public static PopInputMsg ShowPopInputMsg(string titleText, ButtonDelegate.OnClick btnOnClick)
    {
        ...
        args[2] = string.Empty;
        args[3] = btnOnClick;
        return (PopInputMsg)PopWinManager.GetInst().ShowPopWin(typeof(PopInputMsg), args);
    }

    public static PopInputMsg ShowPopInputMsg(string titleText, string defaultText, string inputText, ButtonDelegate.OnClick btnOnClick)
    {
        object[] args = new object[4];
        args[0] = titleText;
        args[1] = defaultText;
