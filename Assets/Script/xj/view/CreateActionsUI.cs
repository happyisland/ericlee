    ...
    protected override void AddEvent()
    {
        try
        {
            ...
            if (null != bg)
            {
                ...
                //UITexture mohu1 = GameHelper.FindChildComponent<UITexture>(bg.transform, "mohu1");
                UITexture mohu2 = GameHelper.FindChildComponent<UITexture>(bg.transform, "mohu2");
            ...
            if (null != iconList)
            {
                ...
                if (null != mGridTrans)
                {
                    ...
                    mGridTrans.localPosition = new Vector3(pos.x, (0.5f - 0.65f) * PublicFunction.GetHeight()); ;
            ...
            if (null != btnOk)
            {
                ...
                Vector3 pos = UIManager.GetWinPos(btnOk, UIWidget.Pivot.Bottom, 0, -2);
                btnOk.localPosition = pos - new Vector3(0, 150);
    ...
    protected override void OnButtonClick(GameObject obj)
    {
        try
        {
            ...
            if (name.Equals("BtnOk") || name.Equals("btnsaveas"))
            {
                ...
                {
                    HUDTextTips.ShowTextTip(LauguageTool.GetIns().GetText("名字为空"));
                }
                else if (ErrorCode.Result_Name_Exist == ret)
                {
                    HUDTextTips.ShowTextTip(LauguageTool.GetIns().GetText("重复名字"));
                }
            }
